...
public class Rook extends Piece implements IPiece{
  ...
  public void move(Coordinate coordinate) {
    if(!checkMatchingCoordinate(position,coordinate)){
    ...
    if(checkContains(validMoves,coordinate)){
 ...
 public boolean checkMatchingCoordinate(Coordinate orgPos,Coordinate newPos){
  ...
  public boolean checkContains(List<Coordinate> coordinates,Coordinate coordinate){
    for(Coordinate coor:coordinates){
      if(coor.getX()==coordinate.getX() && coor.getY()==coordinate.getY()){
        return true;
      }
    }
    return false;
